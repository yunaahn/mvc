   ...
   // @PostMapping("/add")
    public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if(item.getPrice() ==null || item.getPrice() < 1000 || item.getPrice() > 1000000){
            ...
            bindingResult.addError(new FieldError("item", "price", "가격은 1000부터 10000000 까지 입니다."));
        }
        ...
        if(item.getPrice() != null && item.getQuantity() != null){
            ...
            if(resultPrice < 10000) {
                bindingResult.addError(new ObjectError("item", "가격 * 수량의 합은 10000이상이여야합니다. 현재가격 =" + resultPrice));
            }
        }
    ...
    public String addItemV2(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        if(item.getPrice() ==null || item.getPrice() < 1000 || item.getPrice() > 1000000){
            ...
            bindingResult.addError(new FieldError("item", "price", item.getPrice(),false,null,null,"가격은 1000부터 10000000 까지 입니다."));
        }
        if(item.getQuantity() == null || item.getQuantity() >= 9999){
        ...
        if(item.getPrice() != null && item.getQuantity() != null){
            ...
            if(resultPrice < 10000) {
                bindingResult.addError(new ObjectError("item",null ,null,"가격 * 수량의 합은 10000이상이여야합니다. 현재가격 =" + resultPrice));
            }
        }
